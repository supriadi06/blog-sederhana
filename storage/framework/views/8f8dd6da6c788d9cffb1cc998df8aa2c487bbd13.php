		...
		<div class="row"></div>
			<div class="panel panel-default">
			  	<div class="panel-heading clearfix">
			  		<h3 class="panel-title pull-left">Users list</h3>
			  		...
			  		<table class="table table-bordered table-striped">
			  			...
			  			<tbody>
			  				...
			  				<tr>
			  					...
			  					<td class="text-center"><?php echo ($data['id'] == Auth::user()->id) ? "<i class='fa fa-check-square-o'></i> Online" : "<i class='fa fa-minus-square-o'></i>" ?></td>
...
function deletedata(id) 
{
	...
	{
		var str = "<?php echo e(route('users.destroy', 'id')); ?>";
