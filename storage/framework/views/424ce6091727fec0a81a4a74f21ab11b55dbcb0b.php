			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
		          ...
		          <div class="box box-info">
		            <!-- /.box-header -->
		            <!-- form start -->
		            <form class="form-horizontal" action="<?php echo e(route('articles.store')); ?>" method="POST" enctype="multipart/form-data">
		              ...
		              <div class="box-body">
		                ...
		                <div class="form-group">
		                  ...
		                  <div class="col-sm-10">
		                    <input type="file" name="header_pic" accept="image/*" id="header_pic" placeholder="Header Picture" required>
		                  </div>
		                </div>
		                <div class="form-group">
